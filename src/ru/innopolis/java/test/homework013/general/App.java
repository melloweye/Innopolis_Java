package ru.innopolis.java.test.homework013.general;

import java.io.*;
import java.util.ArrayList;
import java.util.List;

import static ru.innopolis.java.test.homework013.general.utils.IntegerParser.validateNumber;
            ...
            for (String part : parts) {
                ...
                if (keyValue.length == 2) {
                    ...
                    try {
                        ...
                        double money = validateNumber(valueString); // использование тестового класса для проверки значений
                        //int money = validateCount(valueString); // можно проверить ввод ценых чисел
            ...
            for (String part : parts) {
                ...
                if (keyValue.length == 2) {
                    ...
                    try {
                        ...
                        double price = validateNumber(valueString); // использование тестового класса для проверки значений
                        //int price = validateCount(valueString); // можно проверить ввод ценых чисел
