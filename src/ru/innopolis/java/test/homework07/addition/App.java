...
Молоко 85 true 5 2024-08-10
Хлеб 45 true 2 2024-08-08
Картофель 60 true
Морковь 65 true
ЗапрещенныйАлкоголь 100 false 10 2024-09-16
ЕщеЗапрещенныйАлкоголь 150 false
END
...
Мишка Молоко
Мишка ЗапрещенныйАлкоголь
Игорь ЗапрещенныйАлкоголь
Игорь Хлеб
Сергей Молоко
Сергей Картофель
Иван Хлеб
Иван ЗапрещенныйАлкоголь
END
...
*/
    ...
    private static Person createPersonFromInput(String input) {
        ...
        if (age < 18) {
            ...
            return new Adult(name, money, age, true); // в данном случае ситуация, когда взрослый все покупает в кредит
        } else {
